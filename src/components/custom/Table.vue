    ...
    <div :class="[{'hide': !toggleSearch}]" style="margin:10px 0">
      <el-row style="margin-bottom:0">
        <template v-for="col in tab.tableDef.cols">
          <el-col style="margin-bottom:5px;padding-right:5px" :span="24 / colCount" v-if="col.isQuery==='True'" :key="col.guid">
            <div :key="col.guid" v-if="col.fieldType==='varchar'">
              <el-input v-model="queryFields[col.field]" :placeholder="col.label" />
            </div>
            <div :key="col.guid" v-else-if="col.fieldType==='date'">
              <el-row>
            ...
            <div :key="col.guid" v-else-if="col.fieldType==='datetime'">
              <el-row>
                <el-col style="padding: 0 10px 0 0" :span="12">
            ...
            <div :key="col.guid" v-else-if="col.fieldType==='number'">
              <el-input v-model="queryFields[col.field+'_BEGIN']" :placeholder="col.label+'开始'" />
              <el-input v-model="queryFields[col.field+'_END']" :placeholder="col.label+'结束'" />
            </div>
          </el-col>
        </template>
      </el-row>
